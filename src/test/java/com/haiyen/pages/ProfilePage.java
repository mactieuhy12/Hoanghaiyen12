...
public class ProfilePage {
    ...
    public void updateProfile() {
        ...
        WebUI.verifyElementVisible(messageUpdateSuccess, "The message not allowed in the demo is not displayed");
        WebUI.waitForPageLoaded();
        WebUI.setTextAndClear(inputName, "Customer Example");
        WebUI.setTextAndClear(inputPhone, "123456");
        WebUI.setTextAndClear(inputPassword, "123456");
        WebUI.setTextAndClear(inputConfirmPassword, "123456");
        WebUI.clickElement(buttonUpdateProfile);
    ...
    public void updateEmail() {
        ...
        WebUI.setTextAndClear(inputEmail, "cashierngan001@gmail.com");
